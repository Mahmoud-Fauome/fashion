      ...
      <div className=" p-4 rounded-3 mt-5 bg-secondary">
        ...
        <div className="mb-2 d-flex justify-content-between">
          <div className="d-flex flex-column">
            <label
              className={CheckFname ? "mb-2 text-light" : "mb-2 text-danger"}
            >
          ...
          <div className="mb-2 d-flex flex-column">
            <label
              className={CheckSname ? "mb-2 text-light" : "mb-2 text-danger"}
            >
          ...
          <div className="mb-2 d-flex flex-column">
            <label
              className={ChekUsName ? "mb-2 text-light" : "mb-2 text-danger"}
            >
        ...
        {/* /////////////////////////////////email//////////////////////////////////// */}
        <label className={CheckEmail ? "mb-2 text-light" : "mb-2 text-danger"}>
        ...
        {/* //////////////////////////////password//////////////////////////////////// */}
        <label
          className={CheckPassword ? "mb-2 text-light" : "mb-2 text-danger"}
        >
        ...
        />
        {/* /////////////////////////////////Image//////////////////////////////////// */}
        <label className={CkekImage ? "mb-2 text-light" : "mb-2 text-danger"}>
        ...
        <div className="mb-3 d-flex justify-content-between">
          <div className=" d-flex flex-column">
            <label
              className={CheckCity ? "mb-2 text-light" : "mb-2 text-danger"}
            >
          ...
          <div className="ms-4 d-flex flex-column">
            <label
              className={CheckGender ? "mb-2 text-light" : "mb-2 text-danger"}
            >
          ...
          <div className="ms-4 d-flex flex-column">
            <label
              className={CheckNumber ? "mb-2 text-light" : "mb-2 text-danger"}
            >
